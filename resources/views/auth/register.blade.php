<x-layout title="Register">
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
        <div class="mb-6">
            <h1 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Create an account</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400">Get started with your free account today.</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div>
                <label for="name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Full
                    name</label>
            ...
            <p class="text-center text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="{{ route('login') }}" class="text-blue-600 hover:underline dark:text-blue-500">Sign in</a>
            </p>
        </form>
    </div>
</x-layout>
